        ...
        <div class="wrapper-box">
            <div class="sidebar">
                ...
                <ul class="nav nav-tabs tab-btn-style-one" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="tab-two-area" data-bs-toggle="tab" href="#tab-two" role="tab" aria-controls="tab-two" aria-selected="false">
                            <h4><span class="dashicons dashicons-category"></span> <?php esc_html_e('All Widgets', 'wpsection'); ?></h4>
                        </a>
                    </li>
<!-- this is tempalte setting for pro version 
<li class="nav-item">
    <a class="nav-link " id="tab-three-area" data-bs-toggle="tab" href="#tab-three" role="tab" aria-controls="tab-three" aria-selected="false">
        <h4><span class="dashicons dashicons-edit-page"></span> <?php esc_html_e('Templates Settings', 'wpsection'); ?></h4>
    </a>
</li>
