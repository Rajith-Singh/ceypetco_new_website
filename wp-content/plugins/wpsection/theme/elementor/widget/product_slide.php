...
class wpsection_product_slide_Widget extends \Elementor\Widget_Base {

    

public function get_name() {
        return 'wpsection_product_slide';
    }

    public function get_title() {
        return __( 'WPS Product Slide ', 'wpsection' );
    }
   ...
   return 'eicon-slider-device';
    ...
    public function get_keywords() {
        return [ 'wpsection', 'product_slide' ];
    }
...
Plugin::instance()->widgets_manager->register( new \wpsection_product_slide_Widget() );
