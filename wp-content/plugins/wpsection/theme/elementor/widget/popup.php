...
class wpsection_popup_Widget extends \Elementor\Widget_Base {


public function get_name() {
		return 'wpsection_popup';
	}
...
Plugin::instance()->widgets_manager->register( new \wpsection_popup_Widget() );