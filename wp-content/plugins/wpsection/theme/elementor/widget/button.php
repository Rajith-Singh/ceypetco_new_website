...
class wpsection_button_Widget extends \Elementor\Widget_Base {


public function get_name() {
		return 'wpsection_button';
	}
...
Plugin::instance()->widgets_manager->register( new \wpsection_button_Widget() );