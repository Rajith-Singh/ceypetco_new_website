...
class wpsection_allslider_Widget extends \Elementor\Widget_Base {



	public function get_name() {
		return 'wpsection_allslider';
	}
...
// Register widget
Plugin::instance()->widgets_manager->register( new \wpsection_allslider_Widget() );
