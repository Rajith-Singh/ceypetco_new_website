...
class wpsection_product_Widget extends \Elementor\Widget_Base {
  
public function get_name() {
		return 'wpsection_product';
	}

	public function get_title() {
		return __( 'WPS Products Basic', 'wpsection' );
	}
...
Plugin::instance()->widgets_manager->register( new \wpsection_product_Widget() );
