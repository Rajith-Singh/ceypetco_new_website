...
namespace LEBUILDPLUGIN\Inc\Post_Types;

use LEBUILDPLUGIN\Inc\Abstracts\Post_Type;
 ...
 *
 * @version  2.6.0
 * @package  LEBUILDPLUGIN/Abstracts
 * @category Abstract Class
 * @author   Wptech
 */
class Testimonials extends Post_Type {

	protected $post_type = 'lebuild_testimonials';
	...
	public static function init() {
		...
		self::instance()->singular  = esc_html__( 'Testimonial', 'wplebuild' );
		self::instance()->plural    = esc_html__( 'Testimonials', 'wplebuild' );
