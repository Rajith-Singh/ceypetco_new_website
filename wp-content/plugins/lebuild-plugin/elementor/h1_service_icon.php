 ...
 * @since 1.0.0
 */
class H1_Service_Icon extends Widget_Base {
	...
	public function get_name() {
		return 'lebuild_h1_service_icon';
	}
	...
	public function get_title() {
		return esc_html__( 'H1 Service Icon', 'lebuild' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'h1_service_icon',
			[
				'label' => esc_html__( 'H1 Service Icon', 'lebuild' ),
			]
		);
		$this->add_control(
			'sec_class',
	...
	protected function render() {
		...
		<section class="service-style1-area <?php echo esc_attr($settings['sec_class']);?>">
			<div class="container">
				<div class="row">
