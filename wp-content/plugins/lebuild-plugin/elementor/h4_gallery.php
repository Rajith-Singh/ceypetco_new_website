 ...
 * @since 1.0.0
 */
class H4_Gallery extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'H4 Gallery', 'lebuild' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'h4_gallery',
			[
				'label' => esc_html__( 'H4 Gallery', 'lebuild' ),
			]
		);
		$this->add_control(
			'sec_class',
	...
	protected function render() {
		...
		<section class="project-style3-area <?php echo esc_attr($settings['sec_class']);?>">
			<div class="container">
