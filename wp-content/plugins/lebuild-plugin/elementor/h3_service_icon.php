 ...
 * @since 1.0.0
 */
class H3_Service_Icon extends Widget_Base {
	...
	public function get_name() {
		return 'lebuild_h3_service_icon';
	}
	...
	public function get_title() {
		return esc_html__( 'H3 Service Icon', 'lebuild' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'h3_service_icon',
			[
				'label' => esc_html__( 'H3 Service Icon', 'lebuild' ),
			]
		);
		$this->add_control(
			'sec_class',
	...
	protected function render() {
		...
		<section class="service-style2-area <?php echo esc_attr($settings['sec_class']);?>">
			<div class="container">
				<div class="row">
					<div class="col-xl-12">
				...
				<div class="row">
					...
					<div class="col-xl-<?php echo esc_attr($item['block_column'], true );?> col-lg-6 col-md-6 wow fadeInDown" data-wow-delay="0ms" data-wow-duration="1500ms">
