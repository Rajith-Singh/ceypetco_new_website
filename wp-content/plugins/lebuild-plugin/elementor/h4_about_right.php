...
class H4_About_Right extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'H4 About Right', 'lebuild' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'h4_about_right',
			[
				'label' => esc_html__( 'H4 About Right', 'lebuild' ),
			]
		);
		$this->add_control(
			'sec_class',
	...
	protected function render() {
		...
		<section class="about-style3-area about-style4-area <?php echo esc_attr($settings['sec_class']);?>">
			<div class="container">
				<div class="row">
					<div class="col-xl-12">
						<div class="about-style4-img-box">
							...
							<div class="image-box2 wow slideInRight" data-wow-delay="100ms" data-wow-duration="2500ms">
