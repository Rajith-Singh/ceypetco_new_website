 ...
 * @since 1.0.0
 */
class H1_Clients extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'H1 Clients', 'lebuild' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'h1_clients',
			[
				'label' => esc_html__( 'H1 Clients', 'lebuild' ),
			]
		);
		$this->add_control(
			'sec_class',
	...
	protected function render() {
		...
		<section class="partner-area <?php echo esc_attr($settings['sec_class']);?>">
			<div class="container">
				<ul class="partner-box partner-carousel owl-carousel owl-theme">
					...
					<li class="single-partner-logo-box">
						...
						<div class="overlay">
							<a href="<?php echo esc_url($item['block_btnlink']['url']);?>"><img src="<?php echo wp_get_attachment_url($item['block_image1']['id']);?>" alt="<?php echo wp_kses($item['block_alt_text1'], $allowed_tags);?>"></a>    
						</div>
					</li>
					<?php endforeach; ?>
				</ul>
