...
class Team_Details_Right extends Widget_Base {
	...
	public function get_name() {
		return 'lebuild_team_details_right';
	}
	...
	public function get_title() {
		return esc_html__( 'Team Details Right', 'lebuild' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'team_details_right',
			[
				'label' => esc_html__( 'Team Details Right', 'lebuild' ),
			]
		);
		$this->add_control(
			'sec_class',
					...
					<div class="col-xl-12">
						<div class="team-member-info-box">
							...
							<ul class="social-links-style1">
								...
								<li>
									<a href="<?php echo esc_url($item['block_btnlink']['url']);?>"><i class="<?php echo str_replace("fa ", "fab ", esc_attr( $item['block_icons']));?>" aria-hidden="true"></i></a> 
								</li>
								<?php endforeach; ?>
							</ul>
						</div>    
