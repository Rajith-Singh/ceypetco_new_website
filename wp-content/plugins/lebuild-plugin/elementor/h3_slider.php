 ...
 * @since 1.0.0
 */
class H3_Slider extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'H3 Slider', 'lebuild' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'h3_slider',
			[
				'label' => esc_html__( 'H3 Slider', 'lebuild' ),
			]
		);
		$this->add_control(
			'sec_class',
	...
	protected function render() {
		...
		<section class="main-slider style3 <?php echo esc_attr($settings['sec_class']);?>">
