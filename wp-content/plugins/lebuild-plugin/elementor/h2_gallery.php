 ...
 * @since 1.0.0
 */
class H2_Gallery extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'H2 Gallery', 'lebuild' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'h2_gallery',
			[
				'label' => esc_html__( 'H2 Gallery', 'lebuild' ),
			]
		);
		$this->add_control(
			'sec_class',
	...
	protected function render() {
		...
		<section class="gallery-area <?php echo esc_attr($settings['sec_class']);?>">
			<div class="container">
				...
				<div class="row masonary-layout">
					...
					<div class="col-xl-<?php echo esc_attr($item['block_column'], true );?> col-lg-6 col-md-6">
						<div class="single-gallery-item">
							<div class="img-holder">
								<img src="<?php echo wp_get_attachment_url($item['block_image']['id']);?>" alt="<?php echo wp_kses($item['block_alt_text'], $allowed_tags);?>">
								<div class="overlay-button">
									<a href="<?php echo esc_url($item['block_btnlink']['url']);?>"><span class="<?php echo str_replace("icon ", " ", esc_attr( $item['block_icons']));?> clr1"></span></a>
								</div>
							</div>
