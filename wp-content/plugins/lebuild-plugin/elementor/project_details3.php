 ...
 * @since 1.0.0
 */
class Project_Details3 extends Widget_Base {
	...
	public function get_name() {
		return 'lebuild_project_details3';
	}
	...
	public function get_title() {
		return esc_html__( 'Project Details 3', 'lebuild' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'project_details3',
			[
				'label' => esc_html__( 'Project Details 3', 'lebuild' ),
			]
		);
		$this->add_control(
			'sec_class',
						...
						<div class="project-details_content">
							<div class="review-box-one">
								...
								<div class="inner">
									...
									<div class="single-review-box marginleft100">
										<div class="img_box">
											<div class="inner">
												<img src="<?php echo wp_get_attachment_url($item['block_image']['id']);?>" alt="<?php echo wp_kses($item['block_alt_text'], $allowed_tags);?>">
											</div>
