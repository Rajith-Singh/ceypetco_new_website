...
class H1_Slider extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'H1 Slider', 'lebuild' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'h1_slider',
			[
				'label' => esc_html__( 'H1 Slider', 'lebuild' ),
			]
		);
		$this->add_control(
			'sec_class',
	...
	protected function render() {
		...
		<section class="main-slider style1 <?php echo esc_attr($settings['sec_class']);?>">
