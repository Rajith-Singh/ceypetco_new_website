 ...
 * @since 1.0.0
 */
class H1_Newsletter extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'H1 Newsletter', 'lebuild' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'h1_newsletter',
			[
				'label' => esc_html__( 'H1 Newsletter', 'lebuild' ),
			]
		);
		$this->add_control(
			'sec_class',
		...
		$this->add_control(
			'subtitle1',
			[
				'label'       => __( 'Placeholder Text', 'rashid' ),
				'type'        => Controls_Manager::TEXTAREA,
				'dynamic'     => [
					'active' => true,
				],
	...
	protected function render() {
		...
		<section class="subscribe-area <?php echo esc_attr($settings['sec_class']);?>">
			<?php  if ( esc_url($settings['bgimg']['id']) ) : ?>
			<div class="subscribe-area_bg" style="background-image: url(<?php echo wp_get_attachment_url($settings['bgimg']['id']);?>);">
			<?php else :?>	
			<div class="noimage">
			<?php endif;?>
			</div>
						...
						<div class="subscribe-content-box wow slideInDown" data-wow-delay="100ms" data-wow-duration="1500ms">
							...
							<div class="subscribe-box">
								<form class="subscribe-form" method="post" action="http://feedburner.google.com/fb/a/mailverify" accept-charset="utf-8">
									...
									<input type="email" name="email" placeholder="<?php echo $settings['subtitle1'];?>">
									<button class="btn-one" type="submit"><span class="txt"><i class="flaticon-paper-plane"></i></span></button>
								</form>
								<p><?php echo $settings['text1'];?><span>*</span></p>
							</div>
							<div class="phone_number">
								...
								<div class="inner_text">
									...
									<h2><a href="tel:<?php echo esc_url($settings['btnlink']['url']);?>"><?php echo $settings['number'];?></a></h2>
								</div>
							</div>
						</div> 
					</div>
