...
class Footer_Widget1 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Footer Widget 1', 'lebuild' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'footer_widget1',
			[
				'label' => esc_html__( 'Footer Widget 1', 'lebuild' ),
			]
		);
		$this->add_control(
			'sec_class',
							...
							<div class="single-footer-widget marbtm wow animated fadeInUp" data-wow-delay="0.1s">
								<div class="our-company-info">
									<div class="footer-logo">
										<a href="<?php echo esc_url($settings['btnlink']['url']);?>"><img src="<?php echo wp_get_attachment_url($settings['image']['id']);?>" alt="<?php echo esc_attr($settings['alt_text']);?>" title="Logo"></a>   
									</div>
									<div class="text-box">
