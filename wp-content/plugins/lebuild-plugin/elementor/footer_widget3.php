...
class Footer_Widget3 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Footer Widget 3', 'lebuild' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'footer_widget3',
			[
				'label' => esc_html__( 'Footer Widget 3', 'lebuild' ),
			]
		);
		$this->add_control(
			'sec_class',
			...
			<div class="footer">
				<div class="container">
					<div class="row text-right-rtl">
						<div class="col-sm-12 wow animated fadeInUp" data-wow-delay="0.8s">
