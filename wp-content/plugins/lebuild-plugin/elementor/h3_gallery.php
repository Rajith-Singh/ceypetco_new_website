 ...
 * @since 1.0.0
 */
class H3_Gallery extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'H3 Gallery', 'lebuild' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'h3_gallery',
			[
				'label' => esc_html__( 'H3 Gallery', 'lebuild' ),
			]
		);
		$this->add_control(
			'sec_class',
	...
	protected function render() {
		...
		<section class="project-style2-area <?php echo esc_attr($settings['sec_class']);?>">
			<div class="container">
				...
				<div class="row">
					<div class="col-xl-12">
						<div class="project-style2_viewmore_button text-center">
