 ...
 * @since 1.0.0
 */
class H1_About extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'H1 About', 'lebuild' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'h1_about',
			[
				'label' => esc_html__( 'H1 About', 'lebuild' ),
			]
		);
		$this->add_control(
			'sec_class',
	...
	protected function render() {
		...
		<section class="about-style1-area <?php echo esc_attr($settings['sec_class']);?>">
			<div class="container">
				<div class="row">
