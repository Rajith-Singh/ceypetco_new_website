 ...
 */
//lebuild_load_default_hooks
function lebuild_load_default_hooks() {

	$config = lebuild_WSH()->config( 'default' );
...
/**
 * [lebuild_main_header_area description]
 *
 * @return [type] [description]
 */

//lebuild_main_header_area
function lebuild_main_header_area() {
	...
	//need to change
	if ( $header == 'header_v1' ) {
		lebuild_template_load( 'templates/header/default-header.php' );
	} elseif ( $header == 'header_v2' ) {
		lebuild_template_load( 'templates/header/header_v2.php' );
	} elseif ( $header == 'header_v3' ) {
		lebuild_template_load( 'templates/header/header_v3.php' );
	} elseif ( $header == 'header_v4' ) {
		lebuild_template_load( 'templates/header/header_v4.php' );
	} elseif ( $header == 'header_v5' ) {
		lebuild_template_load( 'templates/header/header_v5.php' );
	} else {
		lebuild_template_load( 'templates/header/default-header.php' );
	}
}
...
/**
 * [lebuild_main_footer_area description]
 *
 * @return [type] [description]
 */
//lebuild_main_footer_area
function lebuild_main_footer_area() {
	...
	//need to change
	if ( $footer == 'footer_v1' ) {
		lebuild_template_load( 'templates/footer/default-footer.php' );
	} elseif ( $footer == 'footer_v2' ) {
		lebuild_template_load( 'templates/footer/footer_v2.php' );
	} else {
		lebuild_template_load( 'templates/footer/default-footer.php' );
	}
}
...
/**
 * [lebuild_sidebar description]
 *
 * @return [type] [description]
 */
//lebuild_sidebar
function lebuild_sidebar( $data ) {

	lebuild_template_load( 'templates/sidebar.php', compact( 'data' ) );
}

/**
 * [lebuild_banner description]
 *
 * @return [type] [description]
 */
//lebuild_banner
function lebuild_banner( $data ) {

	lebuild_template_load( 'templates/banner/banner.php', compact( 'data' ) );
