...
use LEBUILD\Includes\Classes\Header_Enqueue;
use LEBUILD\Includes\Classes\Options;
...
class Base {
	...
	public static function instance() {
		...
		if ( isset( $GLOBALS['lebuild_base'] ) ) {
			return $GLOBALS['lebuild_base'];
		}
	...
	function option( $key = '' ) {
		...
		$options = (array) get_theme_mod( 'lebuild' . '_options-mods' );

		$dn = lebuild_dot( $options );
