...
$footer_shape_3    = lebuild_set( $footer_shape_3, 'url', LEBUILD_URI . 'assets/images/shape/footer-shape-1.png' );

$footer_shape_4    = $options->get( 'footer_shape_four' );
$footer_shape_4    = lebuild_set( $footer_shape_4, 'url', LEBUILD_URI . 'assets/images/shape/footer-shape-2.png' );
$allowed_html = wp_kses_allowed_html( 'post' );
?>

	<?php if( $options->get('show_news_letter_area_v2') ):?>
                    ...
                    <div class="left pull-left">
                        <div class="subscribe-social-links">
                            ...
                            <?php
								...
								?>
								<li><a href="<?php echo esc_url(lebuild_set( $header_social_icons, 'url' )); ?>" style="background-color:<?php echo esc_attr(lebuild_set( $header_social_icons, 'background' )); ?>; color: <?php echo esc_attr(lebuild_set( $header_social_icons, 'color' )); ?>"><i class="fa <?php echo esc_attr( lebuild_set( $header_social_icons, 'icon' ) ); ?>"></i></a></li>
							<?php endforeach; ?>
                            </ul>
                        </div>    
                    </div>
            ...
            <div class="container">
                <div class="outer-box">
                    <div class="copyright-text text-center">
                        <p><?php echo wp_kses( $options->get( 'copyright_text2', '&copy; Copyright 2021 by <a href="#">lebuild</a>' ), $allowed_html ); ?></p>
                    </div>
                </div>    
            </div>    
        </div>
