                    ...
                    <div class="header-contact-info2 clearfix">
                        <ul class="clearfix">
                            ...
                            <li>
                                ...
                                <div class="text">
                                    <p><?php echo wp_kses( $options->get( 'phone_title_v4'), $allowed_html ); ?></p>
                                    <h4><a href="tel:<?php echo wp_kses( $options->get( 'phone_link_v4'), $allowed_html ); ?>"><?php echo wp_kses( $options->get( 'phone_v4'), $allowed_html ); ?></a></h4>
                                </div>
                            </li>
							<?php endif; ?>	
                            ...
                            <li>
                                ...
                                <div class="text">
                                    <p><?php echo wp_kses( $options->get( 'address_title_v4'), $allowed_html ); ?></p>
                                    <h4><?php echo wp_kses( $options->get( 'address_v4'), $allowed_html ); ?></h4>
                                </div>
                            </li>
							<?php endif; ?>
                        </ul>
            ...
            <div class="outer-box clearfix">
                ...
                <div class="header-bottom_right pull-right">
                    <div class="header-bottom_right__btn_style2 style2instyle3">
                        <a href="<?php echo wp_kses( $options->get( 'quote_link_v4'), $allowed_html ); ?>"><?php echo wp_kses( $options->get( 'quote_v4'), $allowed_html ); ?><span class="flaticon-right-arrow-1 right-arrow"></span></a>
                    </div>  
                </div> 
				<?php endif; ?>
                <?php endif; ?>
